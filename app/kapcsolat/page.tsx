...
export default function ContactPage() {
  return (
    <section className="flex w-full min-h-full flex-col gap-[25px] bg-dark-color py-[150px]">
      ...
      <div className="flex flex-col mb-[150px] w-[90%] max-w-[2560px] mx-auto justify-center items-center">
        <h2 className="flex flex-row gap-[30px] flex-wrap text-center items-center justify-center">
          {h2Elements.map((elem, _) => (
            <span
              key={elem}
              className="text-[20px] md:text-[65px] text-transparent font-black uppercase bg-clip-text bg-gradient-to-r from-white/50 to-green"
            >
              {elem}
            </span>
          ))}
